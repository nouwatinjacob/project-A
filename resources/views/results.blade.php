...
<section class="content">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8 breadcrumbf">
                            <a href="#">Borderlands 2</a> <span class="diviver">&gt;</span> <a href="#">General Discussion</a> <span class="diviver">&gt;</span> <a href="#">Results for {{$query}}</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                            ...
                            <div class="post">
                                <div class="wrap-ut pull-left">
                                    <div class="userinfo pull-left">
                                        <div class="avatar">
                                            <img src="{{ asset($topic->user->avatar) }}" alt="" width="35px" height="35px"/>
                      ...
                      @else
                      <div class="col-lg-8 col-md-8">
                        <h1 class="text-center">No Result found for {{$query}}.</h1>
                      </div>   
                      @endif
                        <!-- SIDEBAR -->
